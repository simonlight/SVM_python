...
if __name__ == "__main__":
    ...
    jsonGazeCategoryIndependent("/local/wangxin/Data/gaze_voc_actions_stefan/ETLoss_ratio", "/local/wangxin/Data/gaze_voc_actions_stefan/ETLoss_json", [90,80,70,60,50,40,30])
